--insert into users
insert into users values (1, 'Джек Лондон');
insert into users values (2, 'Лев Толстой');
insert into users values (3, 'Уильям Шекспир');
insert into users values (4, 'Чарльз Дикенс');
insert into users values (5, 'Александр Пушкин');
